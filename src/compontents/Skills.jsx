         ...
         <div class="content">
            <p class="intro">
             ...
             <ul className="social list-inline">
                 ...
                 <li className="list-inline-item">
                     <img id="js" alt="Sequelize.js" data-bs-toggle="tooltip" title="Sequelize.js" src="https://ajeetchaulagain.com/static/7cb4af597964b0911fe71cb2f8148d64/87351/express-js.png"/>
                 </li>
             </ul>
             <ul>
